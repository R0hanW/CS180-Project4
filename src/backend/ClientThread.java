/***
 * This class which is part of the backend, helps in setting up the Client Thread
 * @author Team 043
 * @version 12/13/2021
 *
 */
...
public class ClientThread implements Runnable {
    ...
    //looked at https://stackoverflow.com/questions/12895450/sending-an-arrayliststring-from-the-server
	// -side-to-the-client-side-over-tcp-us
    @Override
    public void run() {
